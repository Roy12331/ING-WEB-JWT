...
namespace Mvc.Repository.PersonaRepos.PersonaRepo.Mapping
{
    public static class PersonaMapping
    {
        ...
        public static PersonaDto ToDto(this Persona persona)
        {
            return new PersonaDto
            {
                ...
                IdPersonaTipo = persona.IdPersonaTipo,
                IdTipoSexo = persona.IdTipoSexo,
                IdTipoSangre = persona.IdTipoSangre,
        ...
        public static Persona ToEntity(this PersonaDto personaDto)
        {
            return new Persona
            {
                ...
                IdPersonaTipo = personaDto.IdPersonaTipo,
                IdTipoSexo = personaDto.IdTipoSexo,
                IdTipoSangre = personaDto.IdTipoSangre,

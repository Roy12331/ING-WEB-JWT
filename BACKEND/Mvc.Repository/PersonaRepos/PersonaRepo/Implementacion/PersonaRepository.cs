...
using Mvc.Repository.PersonaRepos.PersonaRepo.Mapping;

namespace Mvc.Repository.PersonaRepos.PersonaRepo.Implementacion
{
    public class PersonaRepository : IPersonaRepository
    {
        ...
        public async Task<PersonaDto> Update(PersonaDto request)
        {
            ...
            try
            {
                ...
                person.IdPersonaTipo = request.IdPersonaTipo;
                person.IdTipoSexo = request.IdTipoSexo;
                person.IdTipoSangre = request.IdTipoSangre;
